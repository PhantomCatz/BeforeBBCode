...
{    
    ...
    private final boolean BTM_BALL_PRESENT     = false;//true;
    private final boolean BTM_BALL_NOT_PRESENT = true;//false;

    private boolean btmSensorState = BTM_BALL_NOT_PRESENT;//TOP_BALL_NOT_PRESENT;
    ...
    public DigitalInput btmLimitSwitch;
    ...
    private final int LIMIT_SWITCH_DIO_PORT_BTM = 5;
    ...
    public CatzYdexer() 
    {
        ...
        btmLimitSwitch = new DigitalInput(LIMIT_SWITCH_DIO_PORT_BTM);
            ...
            {  
                ...
                else
                {
                   ...
                   /* btmSensorState = ydexerBtmLimitSwitch.isPressed();
                    ...
                    btmSensorState = btmLimitSwitch.get();//ydexerBtmLimitSwitch.isPressed();
