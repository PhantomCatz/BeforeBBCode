...
public class CatzShooter
{
    ...
    public double servoPositionVariable = 0.0;
    ...
    *----------------------------------------------------------------------------------------*/
    ...
    public final double SHOOTER_RPM_BACKSPIN_OFFSET = 50.0; //300.0; 
    ...
    //auton
    public final double SHOOT_COUNTER_LIMIT_SECONDS      = 1.0;//2.0;
    ...
    public void setTargetRPM(double RPM)
    {
        ...
        *----------------------------------------------------------------------------------------*/
        if(RPM == SHOOTER_TARGET_RPM_VARIABLE_SHOOTER)
        {
         ...
         //   targetRPM = (-5.56*Math.pow(distance,3)) + (67.9*Math.pow(distance,2)) + (-54.0* distance) + 2273.0;
            targetRPM = (-0.000011944122988121*Math.pow(distance,3)) + (0.01016816*Math.pow(distance,2)) + (1.3194414832143* distance) + 2177.6892636036;

            servoPositionVariable = (-0.00000002168*Math.pow(distance,3)) + (0.000007028*Math.pow(distance,2)) + (0.00153*distance) -0.057;
            System.out.println("Target RPM: " + targetRPM);
            System.out.println("Servo Angle: " + servoPositionVariable);
            setServoPosition(servoPositionVariable);
