...
public class CatzAutonomous
{
    ...
    ***************************************************************************/
    ...
    public void blueBeachLeftFender()
    {
        blueBeachRightFender();
    }

    public void blueBeachRightFender()
    {
        autonDeployIntake();
        //Robot.turret.enableAutoAim();
        autonShootFormula();
    ...
    public void blueBeachMiddleThreeCargo() //only for BB(BeachBlitz)
    {
        autonDeployIntake();
        ...
        //Robot.turret.enableAutoAim();
        //driveStraight(-28.0, 3.5, 1.0, NO_INTAKE_ROLLING);   
        autonShootFormula();
        autonIntakeOff();
    ...
    public void blueBeachMiddleFiveCargo()    //for Beach Blitz only
    {
        blueBeachMiddleThreeCargo();
       ...
       // driveStraight(-125.0,5.0,2.5, NO_INTAKE_ROLLING);
      //  Robot.turret.autoAimTurret();                         //if we need to drive back to the point where limelight can reach
     // autonShootFormula();
    ...
    ***************************************************************************/
    ...
    public void redBeachLeftFender()
    {
        blueBeachLeftFender();
    }
    public void redBeachRightFender()
    {
        blueBeachRightFender();
    }
    public void redBeachMiddleThreeCargo()
    {
        blueBeachMiddleThreeCargo();
    }
    public void redBeachMiddleFiveCargo()
    {
        blueBeachMiddleFiveCargo();
    }
